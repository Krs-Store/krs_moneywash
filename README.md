...
<img width="1919" height="1079" alt="Screenshot 2025-08-15 181451" src="https://github.com/user-attachments/assets/02ce5795-dade-4824-8164-53d178ac1af0" />

# 🧼 Money Wash System for FiveM

A simple and immersive **standalone** money laundering system compatible with `ox_inventory` and `ox_lib`.  
Players can interact with one or more configurable zones on the map to convert dirty money into clean money, with progress bar, animation, and notifications.
...
* 🧱 **Standalone**: no dependency on QBCore, ESX, or any framework
